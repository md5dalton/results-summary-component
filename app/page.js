    ...
    <main className="md:w-[736px] md:grid md:items-center grid-cols-2 md:bg-white md:rounded-[2rem] md:shadow-[0_30px_60px_rgba(61,108,236,0.15)]">
        ...
        >
            ...
            <div className="max-w-[260px] grid gap-2 md:gap-3">
                ...
                <p className="text-light-blue md:text-lg">Your performance exceed 65% of the peaople conducting the test here!</p>
            </div>
        </section>
        <section className="
            grid gap-y-6 py-6
        ...
        >
            ...
            />
            <button className="text-white bg-dark-navy rounded-[8rem] h-14 w-full font-bold md:text-lg">Continue</button>
        </section>
    </main>
)